...
typedef enum detect_eq_states { DEQInit, DEQDetect, DEQWait, DEQEnd                                   } detect_eq_states;
typedef enum detect_max_amp_states { DMAInit, DMAWait, DMADetect                         } detect_max_amp_states;
typedef enum detect_zc_states { DZCInit, DZCWait, firstSample, secondSample                                 } detect_zc_states;
typedef enum transmit_states {TInit, TTransmit                                      } transmit_states;
